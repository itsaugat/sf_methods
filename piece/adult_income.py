...
from data_analysis import actionability_constraints, adult_income_dict
...
def piece_loop(X_test, X_test_sc, y_test, X_train, X_train_sc, y_train, df_train, df_test, clf, enc, train_preds,
    ...
    for test_idx in range(len(X_test)):
        ...
        # print(cat_feats[0])
        cat_feats = [mapping_dict[val] for val, mapping_dict in zip(cat_feats[0], adult_income_dict)]
        # print(cat_feats)
...
if __name__ == '__main__':
    ...
    TARGET_NAME = 'income'
    cont_feats = ['age', 'capital_gain', 'capital_loss', 'hours_per_week']
    cat_feats = ['workclass', 'education', 'marital_status', 'occupation', 'relationship', 'race', 'sex', 'country']

    cont_feats_idx = [0, 8, 9, 10]
    cat_feats_idx = [1, 2, 3, 4, 5, 6, 7, 11]
