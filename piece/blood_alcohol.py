...
from data_analysis import actionability_constraints, blood_alcohol_dict
...
if __name__ == '__main__':
    ...
    TARGET_NAME = 'class'
    cont_feats = ['units_consumed', 'weight', 'duration']
    cat_feats = ['gender', 'meal']

    cont_feats_idx = [2, 3, 4]
    cat_feats_idx = [0, 1]
