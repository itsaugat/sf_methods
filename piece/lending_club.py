...
from data_analysis import actionability_constraints, lending_club_dict
...
if __name__ == '__main__':
    ...
    cont_feats = ['loan_amnt', 'pub_rec_bankruptcies', 'annual_inc', 'dti']
    cat_feats = ['emp_length', 'term', 'grade', 'home_ownership', 'purpose']

    cont_feats_idx = [0, 1, 3, 4]
    cat_feats_idx = [2, 5, 6, 7, 8]
