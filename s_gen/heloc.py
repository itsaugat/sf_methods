...
from evaluation_metrics_cont import *
    ...
    for test_idx in range(len(X_test)):
        ...
        if len(sf_list) > 0:
            ...
            for sf in sf_list:
                ...
                # # print(cat_feats[0])
                # cat_feats = [mapping_dict[val] for val, mapping_dict in zip(cat_feats[0], lending_club_dict)]
                # # print(cat_feats)
                #
...
if __name__ == '__main__':
    ...
    TARGET_NAME = 'class'
    cont_feats = ['ExternalRiskEstimate', 'MSinceOldestTradeOpen', 'MSinceMostRecentTradeOpen', 'AverageMInFile',
                  'NumSatisfactoryTrades', 'NumTrades60Ever2DerogPubRec', 'NumTrades90Ever2DerogPubRec',
                  'PercentTradesNeverDelq', 'MaxDelq2PublicRecLast12M', 'MaxDelqEver', 'NumTotalTrades',
                  'NumTradesOpeninLast12M', 'PercentInstallTrades', 'NumInqLast6M', 'NumInqLast6Mexcl7days',
